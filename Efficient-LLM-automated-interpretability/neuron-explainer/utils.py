...
async def get_explanation(mode = "Summary", neuron_record = None, 
                          to_print = False, explainer_model = "Meta-Llama-3.1-8B-Instruct", get_token_only = False):
...
async def get_score(explanation = None, layer = 0, neuron = 1, simulator_model = "Meta-Llama-3.1-8B-Instruct"):
